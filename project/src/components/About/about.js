...
return (
    ...
    <div>
        <div className="about-content">
          ...
          <ul>
            <li><span>Demonstrate high social and environmental performance by achieving a B Impact Assessment score of 80 or above and passing their risk review. Multinational corporations must also meet baseline requirement standards.</span></li>
